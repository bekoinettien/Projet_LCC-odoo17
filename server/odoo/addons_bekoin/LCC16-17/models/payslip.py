        ...
        for record in self:
            self.env['planting.account.move'].create({
                ...
                'invoice': record.partner_id.code_farmer + "/" + record.date_from.strftime(
                    '%d%m%Y') + "-" + record.date_to.strftime('%d%m%Y'), #KONAN - 29-12-2023:record.partner_id.ref remplacé par record.partner_id.code_farmer
                'ref': str(number),
                ...
                'partner_account': line_type == "C" and record.partner_id.code_farmer or False, #KONAN - 29-12-2023:record.partner_id.ref remplacé par record.partner_id.code_farmer
